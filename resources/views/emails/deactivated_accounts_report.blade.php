                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <h3>Rapport des comptes désactivés du mois</h3>
                                            <p>Voici la liste des comptes désactivés ce mois-ci :</p>
                                            <ul>
                                                @foreach ($data['reports'] as $account)
                                                <li>Compte ID: {{ $account->account_number }}, Nom: {{ $account->name }}, Prénom: {{ $account->surname }}, Date de
