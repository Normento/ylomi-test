                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p>Nouvelle transaction sur votre compte
                                                <br>
                                                detail de la transaction : <br>
                                                Type : <b>{{ $body->data['operation'] }}</b> <br>
                                                Montant : <b>{{ $body->data['montant'] }}</b> <br>
                                                Solde : <b>{{ $body->data['solde'] }}</b> <br>
